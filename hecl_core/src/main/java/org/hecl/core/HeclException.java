...
public class HeclException extends Exception {
    ...
    /**
     * @param param   <code>Thing</code> specifying the actual parameter.
     * @param type    String saying the type - ie <i>option </i>, <i>command </i>.
     * @param options A comma-separated list of options that can be supplied.
